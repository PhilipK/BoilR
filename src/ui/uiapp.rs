use eframe::{egui, epi,};
use egui::{TextureHandle,  Stroke, Rounding, ImageButton};
use futures::executor::block_on;
use std::error::Error;
use tokio::{runtime::Runtime, sync::watch::{Receiver, self}};

use crate::{settings::Settings, sync::{download_images, self, SyncProgress}, egs::ManifestItem};

use super::{ui_images::{get_import_image, get_logo, get_logo_icon}, ui_colors::{TEXT_COLOR, BACKGROUND_COLOR, BG_STROKE_COLOR,  ORANGE, PURLPLE, LIGHT_ORANGE, EXTRA_BACKGROUND_COLOR}, ui_import_games::FetchGameStatus};
